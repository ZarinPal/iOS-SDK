...
#ifndef ZARINPAL_MPG_SWIFT_H
#define ZARINPAL_MPG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZarinPal_MPG",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ZarinPal_MPG12CustomButton")
...
SWIFT_CLASS("_TtC12ZarinPal_MPG12CustomUIView")
...
SWIFT_CLASS("_TtC12ZarinPal_MPG19FoundationTransport")
...
SWIFT_CLASS("_TtC12ZarinPal_MPG12NativeEngine") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
